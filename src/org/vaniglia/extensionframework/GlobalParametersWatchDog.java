...
public class GlobalParametersWatchDog {

    private static final Logger logger = Logger.getLogger(GlobalParametersWatchDog.class);
    ...
    public GlobalParametersWatchDog(String configFileName) {
    ...
    public void start() {
        final GlobalParametersWatchDog watchDog = this;
