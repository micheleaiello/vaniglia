...
public interface SocketClient {
    ...
    String invoke(String request) throws NotConnectedException, ConnectionException;

    void setClientSocketSoTimeout(int clientSocketSoTimeout);
    ...
    void setRetriesSleepingTime(int retriesSleepingTime);

    int getRetriesSleepingTime();
}
